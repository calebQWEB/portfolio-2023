        ...
        <nav className='calebq__nav'>
            <div className='calebq__nav-container'>
                <div className='calebq__logo-container'>
                    <Link to="home" spy={true} smooth={true} offset={-80} duration={500}><motion.img src={logo} alt='Logo' className='calebq__logo' animate={scroll ? { x: -35, transition: { ...transition } } : { x: 0, transition: { ...transition } }} /></Link>
                    <Link to="home" spy={true} smooth={true} offset={-80} duration={500}><img src={logo} alt='Logo' className='calebq__mobile-logo' /></Link>
                    {!scroll && (
                ...
                {!scroll && (
                    <ul className='calebq__nav-links'>
                        ...
                        <li><Link to="work" spy={true} smooth={true} offset={-80} duration={500}>Work</Link></li>
